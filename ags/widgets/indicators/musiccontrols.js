      ...
      Widget.Overlay({
        ...
        overlays: [
          ...
          Box({
            ...
            //   [
            //     player,
            //     (self) => self.attribute.updateCover(self),
            //     "notify::cover-path",
            //   ],
            // ],
            setup: (self) => {
...
const main = MarginRevealer({
  transition: "slide_down",
  revealChild: openMusicControls.value,
  showClass: "osd-show",
  hideClass: "osd-hide",
  child: Box({
    setup: (self) =>
...
openMusicControls.connect("changed", ({ value }) => {
  if (value) main.attribute.show();
  else main.attribute.hide();
});
